...
아래 표에 본인의 이름과 GitHub Email을 확인한 후, 희망하는 세미나를 중복되지 않게 **1, 2, 3지망**까지 작성하고, PE 세미나 수강 희망 여부를 작성해 주세요.

- **선택 가능 세미나 (1~3지망)**: `frontend`, `fastapi`, `spring`, `android`
- **PE 수강**: `O` 또는 `X`
...
| 한재민 | includejaemin@snu.ac.kr | spring | frontend | fastapi | X |
